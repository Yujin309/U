...
public class ClickTest2 extends  JFrame{
...
//변수들 
	public ClickTest2() {
		...
		GridBagLayout gridBagLayout = new GridBagLayout();//gridBagLayout= 지역변수 : 생성자 메소드에서 만들어졌기때문에 
		gridBagLayout.columnWidths = new int[] {19, 0, 0, 0, 0, 4};
		gridBagLayout.rowHeights = new int[] {0, 0, 0, 0, 2};
		gridBagLayout.columnWeights = new double[]{0.0, 1.0, 1.0, 1.0, 0.0, Double.MIN_VALUE};
		gridBagLayout.rowWeights = new double[]{0.0, 0.0, 0.0, 0.0, Double.MIN_VALUE};
		getContentPane().setLayout(gridBagLayout);//메소드 선언 !! 매개변수는mgr / 아규먼트..컨테이너 안에 set레이아웃의 grid : 파라미터  
	...
	public static void main(String[] args) {
		...
		ClickTest2  test1 = new ClickTest2();
		test1.pack();
